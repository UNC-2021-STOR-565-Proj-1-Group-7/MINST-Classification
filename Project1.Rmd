...
k10 <- kmeans(minst_kmeans_df, centers = 10, nstart = 25, iter.max = 100)
...
The within-cluster sum of squares of all clusters are shown in the table. We observed that cluster 1, 6, 8, and 7 have high within-cluster sum of squares on the same order of magnitude of the total sum of squares. Cluster 2, 3, 5, and 7 have relatively low within-cluster sum of squares that are approximately 20 times less than the total sum of squares. Cluster 4 and 9 have the medium sum of squares relative to the others, and 10 times less than the total sum of squares. 
...
minst_classification_train <- minst_classification[ran,] 
#extract testing set
minst_classification_test <- minst_classification[-ran,] 
```
...
minst_train_predict <- knn(minst_classification_train,minst_classification_train,cl=minst_target_category,k=5)
...
minst_test_predict <- knn(minst_classification_train,minst_classification_test,cl=minst_target_category,k=5)
