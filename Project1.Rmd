...
```
Looking at the graph of PC1, it has a separation of the digit '0' and '1' from the rest of the digit. The digit '0' tends to have PC1 values below or around -1000, while the digit '1' have PC1 values around 1000. The rest of the digits are in a mix between the digit '0' and '1' between -1000 and 800.

There are no clear cluster in the graph of PC2 in comparison to PC1. However, it still somewhat separated the digit '3' from the rest of the digit. The rest of the digits are blended together. However, PC2 is still able to separate digit '4' and '7' from '6,' '1,' and '2' roughly at the value of around -300, while the digit '9' is scattered throughout the plot.

The plot of PC3 shows less pattern than PC1 or PC2. However, it can still be distinguished that there is a band of digit 1 around the PC3 value of 0. The remaining digits are scattered throughout the plot.
